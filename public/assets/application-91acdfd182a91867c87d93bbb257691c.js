...
(function() {
  var $, cloudmadeAttribution, cloudmadeUrl;

  $ = jQuery;

  $(function() {
    var $field, details, field, lat, lon, map, marker, name, _i, _len, _ref, _results;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      lon = $field.data("longitude");
      name = $field.data("name");
      details = $field.data("details");
      marker = L.marker([lat, lon]).addTo(map);
      _results.push(marker.bindPopup("<b>" + name + "</b><br>" + details));
    }
    return _results;
  });

  cloudmadeUrl = 'http://{s}.tile.cloudmade.com/6d272813d7a8485fb5433dfafdef0cb2/997/256/{z}/{x}/{y}.png';
