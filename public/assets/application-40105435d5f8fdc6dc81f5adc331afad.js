...
(function() {
  ...
  DrawMap = {
    SetLayer: function() {
      var map;
      map = L.map('map');
      return L.tileLayer("http://{s}.tile.cloudmade.com/6d272813d7a8485fb5433dfafdef0cb2/997/256/{z}/{x}/{y}.png", {
  ...
  $(function() {
    var $field, addr, desc, field, lat, lon, map, marker, _i, _len, _ref;
    map = DrawMap.SetLayer;
    _ref = $(".field");
