...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { city: @field.city, country: @field.country, latitude: @field.latitude, longitude: @field.longitude, street: @field.street }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { city: @field.city, country: @field.country, latitude: @field.latitude, longitude: @field.longitude, street: @field.street }
    assert_redirected_to field_path(assigns(:field))
  end
